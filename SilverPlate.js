...
//,'https://cdn.discordapp.com/attachments/495370972644245504/495371386886553612/Your_life_matters.png','https://cdn.discordapp.com/attachments/495370972644245504/495373216668319754/When_life_gives_you_lemon.png','https://cdn.discordapp.com/attachments/495370972644245504/495373662824824844/unknown.png
...
socket.on('message',function(data){
    ...
    if(data.msg.startsWith('93!')&&data.nick!=undefined){
        ...
        if(data.msg.startsWith('time')){
          ...
          socket.emit('message','🕒 '+timehours+':'+timeminutes+':'+timeseconds+' '+ampm)
        }
